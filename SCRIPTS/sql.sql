...
/* ENDERECO - OBRIGATORIO 1
CADASTRO DE SOMENTE UM. 1

TELEFONE - NAO OBRIGATORIO 0
CADASTRO DE MAIS DE UM (OPCIONAL) /* n
...
INSERT INTO CLIENTE VALUES(NULL,'JORGE','M','JORGE@IG.COM','8756547688');
INSERT INTO CLIENTE VALUES(NULL,'CELIA','M','JCELIA@IG.COM','5767876889');
INSERT INTO CLIENTE VALUES(NULL,'xxx','M','JCELIAx@IG.COM','5747876889');
...
1
select c.IDCLIENTE, c.nome, c.sexo, c.email, c.cpf, e.IDENDERECO, e.rua, e.BAIRRO, e.cidade, e.estado, t.IDTELEFONE, t.tipo, t.numero
from cliente c 
inner join endereco e
on c.IDCLIENTE = e.ID_CLIENTE
inner join telefone t
...
GROUP BY SEXO;
5
select c.IDCLIENTE, c.nome, c.email, t.tipo, e.bairro, e.cidade
from cliente c 
inner join endereco e
on c.IDCLIENTE = e.ID_CLIENTE
inner join telefone t
...
SELECT C.NOME, C.EMAIL, T.TIPO, T.NUMERO AS CELULAR, E.ESTADO
FROM CLIENTE C
INNER JOIN ENDERECO E
ON C.IDCLIENTE = E.ID_CLIENTE
INNER JOIN TELEFONE T
...
INSERT INTO veiculos VALUES (1, 'Carro', 'xxxxx');
INSERT INTO veiculos (funcionario_id, veiculo, placa) VALUES (2, 'Carro', 'SB-0002');

INSERT INTO veiculos (funcionario_id, , placa) VALUES (1, 'SB-0001');
